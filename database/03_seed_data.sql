...
USING (
    VALUES
        ...
        (1021, 103, N'BIZ-OL-3003', CONVERT(DATETIME2, '2026-07-08T10:25:00'), N'CUST-1003', CAST(-18.20 AS DECIMAL(12,2)), N'Cafe Nord', N'Dining', N'Mobile', N'Seattle, WA'),
...
-- Seed a few example alerts.
-- The v0 ruleset keeps these demonstration alerts separate from the v1
-- alerts generated by the Pandas analysis engine.
...
USING (
    VALUES
        (
            ...
            N'Large purchase exceeded the demonstration threshold.'
        ),
        (
            5002,
            1010,
            ...
            N'[
                {
                    ...
                    "explanation": "The recorded customer reference differed from the joined customer reference.",
                    "points": 25,
                    "evidence": {
            ...
            N'Recorded customer reference did not match the joined customer.'
        ),
        (
            5003,
            1018,
            ...
            N'[
                {
                    ...
                    "explanation": "The transaction location was inconsistent with nearby customer activity.",
                    "points": 25,
                    "evidence": {
                        "location": "Riyadh, SA"
                    }
            ...
            N'Foreign ATM activity was unusual for this demonstration customer.'
        )
) AS source (
    alert_id,
    transaction_id,
